        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">
                    {{ __('expenses.create_new_expense') }}
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('expenses.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
